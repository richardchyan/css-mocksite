...
const Blog = () => {
   return (
      <div className="max-w-screen-lg m-auto w-3/4">
         {/* Main blog header title */}
         <div className="my-10">
            <h1 className="text-5xl bg-gradient-to-r from-red-400 via-blue-400 to-blue-200 text-transparent bg-clip-text py-2">A lot is happening,</h1>
            <h2 className="text-5xl bg-gradient-to-r from-red-400 via-blue-400 to-blue-200 text-transparent bg-clip-text py-2">We are blogging about it</h2>
         </div>
