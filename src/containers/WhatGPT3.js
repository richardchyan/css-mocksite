      ...
      <div id="wgpt3">
         ...
         <div className="text-blue-50 w-3/4 max-w-screen-lg p-8 m-auto bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-900 space-y-6">
            ...
            <div className="flex justify-between">
               <h1 className="text-lg text-left w-1/4">What is GPT-3?</h1>
               <p className="text-sm text-left font-thin text-blue-200 w-2/3">We so opinion friends me message as delight. Whole front do of plate heard oh ought. His defective nor convinced residence own. Connection has put impossible own apartments boisterous. At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by.</p>
            </div>
            {/* heading container */}
            <div className="flex justify-between items-center">
               <h2 className="text-2xl bg-gradient-to-r from-red-400 via-blue-400 to-blue-200 text-transparent
               bg-clip-text text-left w-2/4 border-blue-300">
                  The possibilities are beyond your imagination
               </h2>
               <p className="text-md w-1/4">Explore the library</p>
            </div>
