...
const CallToAction = () => {
   return (
      <div className="mt-10">
         ...
         <div className="bg-gradient-to-r from-red-400 via-blue-400 to-blue-200 max-w-screen-lg m-auto w-4/5 rounded-lg p-6 flex flex-col space-y-2 lg:space-y-0 lg:flex-row justify-between items-center">
            <div>
